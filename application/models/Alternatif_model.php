...
class Alternatif_model extends CI_Model
{
	...
	public function get_data()
	{
		...
		$this->db->join('monitor', 'monitor.id_monitor = alternatif.id_monitor');

		return $this->db->get();
	}
	function alternatif_add($id_monitor, $kriteriaData = array(), $sub = array())
	{
		if ($this->m_db->is_bof('monitor') == FALSE) {
